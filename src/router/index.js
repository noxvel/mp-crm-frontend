...
export const constantRoutes = [
...

  {
    path: '/individual',
    component: Layout,
    redirect: '/individual/person',
    name: 'Individual',
    meta: { title: 'Individual', icon: 'example' },
    children: [
      {
        path: 'person',
        name: 'Person',
        component: () => import('@/views/person/index'),
        meta: { title: 'Person', icon: 'link' }
      },
      {
        path: 'contract',
        name: 'Contract',
        component: () => import('@/views/contract/index'),
        meta: { title: 'Contract', icon: 'table' }
      },
      {
...

  {
    ...
    name: 'Organization',
    meta: { title: 'Organization', icon: 'eye-open' },
    children: [
      {
        path: 'company',
        name: 'Company',
        component: () => import('@/views/company/index'),
        meta: { title: 'Company', icon: 'table' }
      },
      {
        path: 'agreement',
        name: 'Agreement',
        component: () => import('@/views/agreement/index'),
        meta: { title: 'Agreement', icon: 'tree' }
      },
      {
